  ...
  <div class="container-wrap">
    ...
    <el-form class="login" :rules="rules" label-position="right" ref="loginForm" :model="form">
      ...
      <el-form-item prop="username"> 
        <el-input class="el-input" prefix-icon="el-icon-user-solid" v-model="form.username" placeholder="用户名"></el-input>
      </el-form-item>

      <el-form-item prop="userpass">
        <el-input class="el-input" type="password" prefix-icon="el-icon-lock" show-password v-model="form.userpass" placeholder="密码"></el-input>
      </el-form-item>
      ...
      async loginFn(){
        ...
        try {
            if(data.errcode==0){
              ...
              localStorage.setItem('lastSession', data.lastSession);

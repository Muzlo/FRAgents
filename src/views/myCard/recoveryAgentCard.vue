                    ...
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="代理商">
                                <el-select v-model="formAllInfo.agentId2" filterable placeholder="请选择">
                        ...
                        <el-col :span="16">
                            ...
                            <el-form-item>
                                <el-button type="primary" @click="allHuiShouFn">全部回收</el-button>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
                    ...
                    <el-row>
                        ...
                        <el-col :span="16">
                            <el-form-item>
                                ...
                                >
                                    <el-button type="primary">Excel 导入回收</el-button>
                                </el-upload>
                            </el-form-item>
                        </el-col>
                    </el-row>
...
<el-table border :stripe="true" :height="tableHeight" :data="tableList.slice((currentPage-1)*pageSize,currentPage*pageSize)" style="width: 100%">
    ...
    <el-table-column label="代理商" prop="agentname" align="center" width="200"></el-table-column>
    ...
    <el-table-column align="right" fixed="right" width="150">
      ...
      <template slot-scope="scope">
        <el-button size="mini" type="success" @click="huiShou(scope.row.cardid)">回收</el-button>
      </template>
    </el-table-column>
</el-table>
...
export default {
    ...
    methods:{
        async searchTableData(){
            ...
            let searchObj={...this.formAllInfo,...userid,...agentid,...username};

            try{
                const data = await this.$axios.post(
                "/fr/REUSIM/queryReAgentUSIM",
        ...
        allHuiShouFn(){
            ...
            var allHuiShou=async ()=>{
                if(this.formAllInfo.startCard && this.formAllInfo.endCard){
                    let paramsObj={
                    ...
                    this.$message.warning("卡号范围查询不能为空！");
                }
            }
            this.confirmFn("全部回收",allHuiShou);
        },
        //单个回收
        huiShou(id){
            var huiShouFn=async ()=>{
